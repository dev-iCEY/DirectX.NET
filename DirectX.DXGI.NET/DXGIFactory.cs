...
{
    /// <summary>An DXGIFactory interface implements methods for generating DXGI objects (which handle fullscreen transitions).</summary>
    ...
    public class DXGIFactory : DXGIObject, IDXGIFactory
    {
        ...
        /// </summary>
        protected new const uint LastMethodId = 11u;
